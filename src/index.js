 ...
 * map, filter
 */
const nameArySec24 = ["田中", "やまだ", "Jakei"];

const newNameArySec24 = nameArySec24.map((name) => {
  if (name === "Jakei") {
    return name;
  } else {
    return `${name}さん`;
...
// 新しくmapで生成された配列の確認
// ["田中さん", "やまださん", "Jakei"]
console.log(newNameArySec24);

const numArr24 = [1, 2, 3, 4, 5];
const newNumArr24 = numArr24.filter((num) => {
  return num % 2 === 0;
});
